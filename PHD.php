        ...
        <form class="f" method="post" action="homePage.php">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" placeholder="diploma in" name="diplomaIn">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Round Diploma</label>
                    <input type="tel" class="form-control" id="validationCustom01" placeholder="roundDiploma" name="roundDiploma">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Department</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="department" name="departmentD">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Department Rating</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="department rating" name="rateD">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Graduated from</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="Graduated from" name="graduateCollegeD">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">University</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="university" name="universityD">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" placeholder="Master in" name="masterIn">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Round Master</label>
                    <input type="tel" class="form-control" id="validationCustom01" placeholder="roundMaster" name="roundMaster">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Department</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="department" name="departmentM">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Department Rating</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="department rating" name="rateM">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Graduated from</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="Graduated from" name="graduateCollegeM">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">University</label>
                    <input type="text" class="form-control" id="validationCustom01" placeholder="university"name="universityM">
                </div>
            </div>
            <button type="submit" class="btn btn-primary" name="reg_phd">
              Submit
            </button>
        </form>
    </div>
