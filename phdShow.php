...
$stmt = $conn->prepare(
    "SELECT * FROM phd WHERE idPhd=$id"
);
$stmt->execute([$id]);
$row = $stmt->fetch();
;
?>
    ...
    <div class="main rounded">
        <h1 class="text-center">Student Registration Form for PHD</h1>
        <form class="f" method="post" action="homePage.php">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">First name</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="First name" name="Fname"value="<?php echo $row['Fname'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Father's name</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="Father's name" name="Lname"value="<?php echo $row['Lname'];?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Date of birth</label>
                    <input disabled type="date" class="form-control" id="validationCustom01" placeholder="DOF" name="date"value="<?php echo $row['date'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Village</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="village" name="village"value="<?php echo $row['village'];?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">District</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="district" name="district"value="<?php echo $row['district'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Government</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="government" name="government"value="<?php echo $row['government'];?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
            ...
            <h3>Master Information<br><br></h3>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Master In</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="Master in" name="masterIn"value="<?php echo $row['masterIn'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Round Master</label>
                    <input disabled type="tel" class="form-control" id="validationCustom01" placeholder="roundMaster" name="roundMaster"value="<?php echo $row['roundMaster'];?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Department</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="department" name="departmentM"value="<?php echo $row['departmentM'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Department Rating</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="department rating" name="rateM"value="<?php echo $row['rateM'];?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="validationCustom01">Graduated from</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="Graduated from" name="graduateCollegeM"value="<?php echo $row['graduateCollegeM'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="validationCustom01">University</label>
                    <input disabled type="text" class="form-control" id="validationCustom01" placeholder="university"name="universityM"value="<?php echo $row['universityM'];?>">
                </div>
            </div>
            <button disabled type="submit" class="btn btn-primary" name="reg_phd"value="<?php echo $row['reg_phd'];?>">
              Submit
            </button>
        </form>
    </div>
